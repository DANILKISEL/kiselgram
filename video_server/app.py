...
CORS(app, origins=['https://kiselgram.ru', 'https://web.kiselgram.ru', 'https://status.kiselgram.ru', 'http://localhost:5500'])
app.wsgi_app = ProxyFix(app.wsgi_app, x_for=app.config['TRUSTED_PROXIES'], x_proto=1, x_host=1)
socketio = SocketIO(app, cors_allowed_origins=["https://kiselgram.ru", "https://web.kiselgram.ru", "https://status.kiselgram.ru"], ping_timeout=60, ping_interval=25)
